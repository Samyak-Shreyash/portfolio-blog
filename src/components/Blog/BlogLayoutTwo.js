...
const BlogLayoutTwo = ({ blog }) => {
  return (
    <div className="group grid grid-cols-12 gap-4 items-center text-black dark:text-gray">
      <Link
        href={blog.url}
      ...
      <div className="col-span-12 lg:col-span-8 w-full">
        ...
        <span className="inline-block w-full capitalize text-gray dark:text-gray/50 font-semibold text-xs sm:text-base">
